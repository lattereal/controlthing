...
if LocalPLR.Name ~= Username then
    ...
    -- Simple screen GUI for privacy mode or 3D rendering off
    local screenGui
    ...
    -- Helper to check if a player rig is R15 or R6
    ...
    function commands(player, message)
        ...
        if msg:sub(1, 6) == Prefix .. "bring" then
            LocalPLR.Character:FindFirstChild("HumanoidRootPart").CFrame =
                game.Players[player.Name].Character:FindFirstChild("HumanoidRootPart").CFrame
        end
        ...
        if msg:sub(1, 6) == Prefix .. "speed" then
            ...
            LocalPLR.Character.Humanoid.WalkSpeed = tonumber(args[1]) or 16
        end
        ...
        -- SURROUND:
        if msg:sub(1, 9) == Prefix .. "surround" then
            local args = getArgs(message:sub(11))
            local targetPLR = getFullPlayerName(args[1])
            local playerPos = game.Players[targetPLR].Character.HumanoidRootPart
            ...
            local newPosition = playerPos.Position + offset
            lpr.CFrame = CFrame.new(newPosition, playerPos.Position)
        end
        ...
        if msg:sub(1, 3) == Prefix .. "4k" then
            ...
            if game.Players[targetPLR] then
                ...
                local offsetAngle = rot - (index * spacing)
                local offset = Vector3.new(sin(offsetAngle) * eclipse, 0, cos(offsetAngle) * radius)
                local newPosition = game.Players[targetPLR].Character.HumanoidRootPart.Position + offset
                LocalPLR.Character.HumanoidRootPart.CFrame = CFrame.new(newPosition, game.Players[targetPLR].Character.HumanoidRootPart.Position)
                chat("📸CAUGHT IN 4K📸")
            end
        end
        ...
        if msg:sub(1, 5) == Prefix .. "jork" then
            ...
            local jorkAnim, animTrack, jorkAnim2, animTrack2
        ...
        if msg:sub(1, 7) == Prefix .. "unjork" then
            for _, track in pairs(LocalPLR.Character.Humanoid:GetPlayingAnimationTracks()) do
                track:Stop()
            end
        end
        ...
        -- ORBIT:
        local orbit1, orbit2, lineorbitF
        if msg:sub(1, 6) == Prefix .. "orbit" then
            ...
            orbit1 = RunService.Stepped:connect(function(t, dt)
                rot = rot + dt * rotspeed
                local offsetAngle = rot - (index * spacing)
                local offset = Vector3.new(sin(offsetAngle) * eclipse, 0, cos(offsetAngle) * radius)
                local newPosition = playerPos.Position + offset
        ...
        if msg:sub(1, 7) == Prefix .. "2orbit" then
            ...
            orbit2 = RunService.Stepped:connect(function(t, dt)
                rot = rot + dt * rotspeed
                local offsetAngle = rot - (index * spacing)
                local offset = Vector3.new(sin(offsetAngle) * eclipse, 0, cos(offsetAngle) * radius)
                local newPosition = playerPos.Position + offset
        ...
        if msg:sub(1, 10) == Prefix .. "lineorbit" then
            ...
            lineorbitF = RunService.Stepped:connect(function(t, dt)
                rot = rot + dt * rotspeed
            ...
            if game.Players[targetPLR] then
                followF = RunService.Heartbeat:Connect(function()
                    LocalPLR.Character:FindFirstChild("Humanoid"):MoveTo(
                        game.Players[targetPLR].Character:FindFirstChild("HumanoidRootPart").Position
                    )
                end)
            end
        end
        ...
        if msg:sub(1, 11) == Prefix .. "linefollow" then
            ...
            if game.Players[targetPLR] then
                linefollowF = RunService.Heartbeat:Connect(function()
                    LocalPLR.Character:FindFirstChild("Humanoid"):MoveTo(
                        (game.Players[targetPLR].Character:FindFirstChild("HumanoidRootPart").CFrame
                        * CFrame.new(0, 0, spacing * index)).Position
                    )
                    LocalPLR.Character.HumanoidRootPart.CFrame = CFrame.new(
                        LocalPLR.Character.HumanoidRootPart.Position,
            ...
            wormF = RunService.Heartbeat:Connect(function()
                if index == 1 then
                    LocalPLR.Character.Humanoid:MoveTo(
                        game.Players[targetPLR].Character.HumanoidRootPart.Position + Vector3.new(0, 0, -1)
                    )
                else
                    LocalPLR.Character.Humanoid:MoveTo(
                        game.Players[botInfront].Character.HumanoidRootPart.Position + Vector3.new(0, 0, -1)
                    )
                end
            end)
        end
        ...
        if msg:sub(1, 10) == Prefix .. "partsrain" then
            ...
            if game.Players[targetPLR] then
                rainF = RunService.Heartbeat:Connect(function()
                    local hum = LocalPLR.Character:FindFirstChild("Humanoid")
                    if hum and hum.Health > 0 then
                        if hum.Sit == true then
                            hum.Sit = false
                        end
                        LocalPLR.Character:WaitForChild("HumanoidRootPart", 5).CFrame =
                            game.Players[targetPLR].Character.HumanoidRootPart.CFrame + Vector3.new(0, fallHeight, 0)
                        ...
                        rainF:Disconnect()
                        wait(3)
                        -- Optional: re-run the code if you want a loop
                        -- runCode()
                    end
                end)
            end
            ...
            for i = 1,360 do
                delay(i/720,function()
                    ...
                    LocalPLR.Character.HumanoidRootPart.CFrame =
                        LocalPLR.Character.HumanoidRootPart.CFrame * CFrame.Angles(0.0174533, 0, 0)
                end)
            end
            wait(0.55)
        ...
        if msg:sub(1, 6) == Prefix .. "stack" then
            ...
            if game.Players[targetPLR] then
                ...
                stackF = RunService.Heartbeat:Connect(function()
                    ...
                    LocalPLR.Character.HumanoidRootPart.CFrame =
                        game.Players[targetPLR].Character.Head.CFrame * CFrame.new(0, offset, 0)
                end)
            end
        end
            ...
            if game.Players[targetPLR] then
                ...
                stackF2 = RunService.Heartbeat:Connect(function()
                    ...
                    if index == 1 then
                        ...
                        LocalPLR.Character.HumanoidRootPart.CFrame =
                            game.Players[botInfront].Character.Head.CFrame * CFrame.new(0, 1.5, 0)
                    end
                end)
            end
        end
        ...
        if msg:sub(1, 6) == Prefix .. "fling" then
            ...
            followF = RunService.Heartbeat:Connect(function()
                LocalPLR.Character.HumanoidRootPart.CFrame =
                    game.Players[targetPLR].Character.HumanoidRootPart.CFrame
            end)
        end
        ...
        -- BANG:
        local bangAnim, anim, bangLoop
        local bangAnim3, anim3, bangLoop2
        if msg:sub(1, 5) == Prefix .. "bang" then
            ...
            if game.Players[targetPLR] then
                ...
                local plrHum = LocalPLR.Character.Humanoid
                ...
                bangLoop = RunService.Stepped:Connect(function()
                    wait()
                    LocalPLR.Character.HumanoidRootPart.CFrame =
                        game.Players[targetPLR].Character.HumanoidRootPart.CFrame * CFrame.new(0, 0, 1.1)
                end)
            end
        end
        ...
        if msg:sub(1, 6) == Prefix .. "2bang" then
            ...
            if game.Players[targetPLR] then
                ...
                local plrHum3 = LocalPLR.Character.Humanoid
                ...
                bangLoop2 = RunService.Stepped:Connect(function()
                    ...
                    if index == 1 then
                        ...
                        LocalPLR.Character.HumanoidRootPart.CFrame =
                            game.Players[botInfront].Character.HumanoidRootPart.CFrame * CFrame.new(0, 0, 1.1)
                    end
                end)
            end
        end
        ...
        -- FACEBANG:
        local bangAnim2, anim2, facebangLoop
        local facebangLoop2
        if msg:sub(1, 9) == Prefix .. "facebang" then
            ...
            if game.Players[targetPLR] then
                ...
                facebangLoop = RunService.Stepped:Connect(function()
                    ...
                    targetRoot.CFrame =
                        game.Players[targetPLR].Character:FindFirstChild("HumanoidRootPart").CFrame
                        * bangOffet * CFrame.Angles(0,3.15,0)
            ...
            if game.Players[targetPLR] then
                ...
                facebangLoop2 = RunService.Stepped:Connect(function()
                    ...
                    if index == 1 then
                        ...
                        targetRoot.CFrame =
                            game.Players[targetPLR].Character:FindFirstChild("HumanoidRootPart").CFrame
                            * bangOffet * CFrame.Angles(0,3.15,0) * CFrame.new(0, 0, (index - 1))
                    end
                    targetRoot.Velocity = Vector3.new(0,0,0)
                end)
            end
        ...
        if msg:sub(1, 9) == Prefix .. "announce" then
            ...
            if index == 1 then
                ...
                chat(
                    "." .. blob .. " " .. blob .. " " .. blob .. " " .. blob .. " " .. blob 
                    .. " " .. blob .. " " .. blob .. "🚨 Important Announcement: "
                    .. msg:sub(11)
                    .. " 🚨" .. blob .. " " .. blob .. " " .. blob .. " " .. blob
                    .. " " .. blob .. " " .. blob .. "."
                )
        ...
        if msg:sub(1, 4) == Prefix .. "riz" then
            ...
            wait(5 * (index - 1))
            local rizzFollow = RunService.Heartbeat:Connect(function()
                LocalPLR.Character.HumanoidRootPart.CFrame =
                    CFrame.lookAt(
                        (game.Players[targetPLR].Character.HumanoidRootPart.CFrame
                        * CFrame.new(0, 0, -2)).Position,
                        game.Players[targetPLR].Character.HumanoidRootPart.Position
                    )
            end)
                        ...
                        LocalPLR.Character.HumanoidRootPart.CFrame =
                            CFrame.lookAt(
                                ...
                                * CFrame.new(0, 0, 1)).Position,
                                game.Players[targetPLR].Character.HumanoidRootPart.Position
                            ) * CFrame.new(1, 0, 0) * CFrame.Angles(0, 0, 65)
                    else
                        LocalPLR.Character.HumanoidRootPart.CFrame =
                            CFrame.lookAt(
                                (game.Players[targetPLR].Character.HumanoidRootPart.CFrame
        ...
        if msg:sub(1, 7) == Prefix .. "bridge" then
            ...
            if index == 1 then
                ...
                bridgeF = RunService.Heartbeat:Connect(function(deltaTime)
                    LocalPLR.Character.HumanoidRootPart.CFrame =
                        game.Players[botInfront].Character.HumanoidRootPart.CFrame
                        * CFrame.new(0, 0, -(index + 1.5))
                end)
            end
        end
        ...
        -- CARPET:
        local carpetAnim, carpet, carpetF
        ...
        -- FULLBOX:
        local fullboxF
        local carpetAnim2, carpet2, carpetAnim3, carpet3
                ...
                stairsF = RunService.Heartbeat:Connect(function(deltaTime)
                    LocalPLR.Character.HumanoidRootPart.CFrame =
                        CFrame.new(
                            (game.Players[botInfront].Character.HumanoidRootPart.CFrame
                            * CFrame.new(0, 0, 2)).Position,
                            game.Players[botInfront].Character.HumanoidRootPart.Position
                        ) * CFrame.new(0, 2, 0)
                end)
            end
        end
        ...
        -- DANCE (Emotes from built-in /e dance, wave, cheer, etc.)
        if msg:sub(1, 6) == Prefix .. "dance" then
            local args = getArgs(msg:sub(8))
            if not args[1] then
                if index == 1 then
                    chat("Pick an emote or type " .. Prefix .. "dance list!")
                end
            else
                if args[1] == "1" then
        ...
        if msg:sub(1, 7) == Prefix .. "fpscap" then
            ...
            if not tonumber(args[1]) then
                if index == 1 then
                    chat("Please specify a number for fpscap.")
                end
                return
            end
        ...
        if msg:sub(1, 5) == Prefix .. "cmds" then
            ...
            if index == 1 then
                if page == "1" then
                    chat("rejoin, jump, reset, sit, chat (message), shutdown, orbit (username)/unorbit, bang (username) (speed)/unbang, walkto (username), speed (number), bring, clearchat, privacymode (enable/disable)")
                    wait(0.2)
                ...
                elseif page == "3" then
                    chat("unbridge, copychat (username)/uncopychat, (New) .emote 1|2|3|4")
                else
        ...
        --------------------------------------------------------------------------------
        ---- NEW EMOTE COMMAND (All bots do it, no indexes needed) ---------------------
        --------------------------------------------------------------------------------

        if msg:sub(1, 6 + #Prefix) == Prefix .. "emote" then
            -- Example usage in chat: ".emote 1"
            -- That will make all bots do Emote #1 (Griddy).

            -- We'll read the entire string after ".emote " to find which emote number.
            local chosenEmote = message:sub(#Prefix + 7)  -- e.g. "1" or "2" or "3" or "4"
            chosenEmote = chosenEmote:lower() -- just in case

            local animId

            -- Decide which animation ID to use based on your desired 4 emotes:
            -- Replace these placeholders with the real IDs you have.
            if chosenEmote == "1" then
                -- Emote #1 = Griddy
                animId = "rbxassetid://10722615238"
            elseif chosenEmote == "2" then
                -- Emote #2 = Scenario
                animId = "rbxassetid://5641878449"
            elseif chosenEmote == "3" then
                -- Emote #3 = Kazotsky Kick
                animId = "rbxassetid://10852094160"
            elseif chosenEmote == "4" then
                -- Emote #4 = Sturdy
                animId = "rbxassetid://10507080897"
            else
                if index == 1 then
                    chat("Please specify a valid emote: 1=Griddy, 2=Scenario, 3=Kazotsky Kick, 4=Sturdy")
                end
                return
            end

            -- We'll define a small function to load the chosen animation and play it:
            local function runEmote()
                -- If your animation is for R15 only:
                if not isR15() then
                    if index == 1 then
                        chat("This command requires an R15 rig!")
                    end
                    return
                end
                ...
                local track = LocalPLR.Character.Humanoid:LoadAnimation(emoteAnim)
                track.Looped = true
                track:Play()
            end

            -- Since you want **all** bots to do it, we simply call runEmote()
            -- (No specifying indexes or anything.)
            runEmote()
        end
